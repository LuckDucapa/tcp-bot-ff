...
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]P O W E R E DㅤB Y DULU 
[FFFF00]━━━━━━━━━━━━━━━━━━━━━
[B][C][00FF00]F O L L O WㅤM EㅤI NㅤI N S T A G R A Mㅤ[FFFFFF]@dulu._.09
[00008B]━━━━━━━━━━━━━━━━━━━━━
...
[FFD700]👑 NAME : [FFFF00]Dulu  ⚡   
[FFD700]📌 Instagram : [00BFFF]@dulu._.091 
[FF1493]╚══════════════════════════╝""", idinv
                            )
                    )
                    senthi = False
...
[00BFFF][c]@dulu._.09[/c]

[FFFFFF][b][c]Developer:[FFD700] Dulu[/c][/b]
...
[FFFFFF]          ⚡[FFFF00] DULU ❤️  
[FFFFFF]                   thank for support 
[00BFFF]╠═════[FFFFFF]═════╣
[FFFFFF]⚡ OWNER : [FFFF00] Dulu X   
[FFFFFF]⚡ TELEGRAM : [FFFF00]@dulu_x 
[FFFFFF]✨ Name on instagram : [FFFF00]_ @dulu._.09❤️  
[00BFFF]╚═════[FFFFFF]═════╝
[FFFFFF]✨ Developer —͟͞͞ </> [FFFF00] dulu_x  ⚡""", uid
                            )
                        )
                    except Exception as e:
                ...
                if "1200" in data.hex()[0:4] and b"/s1" in data:
                    try:
                        ...
                        if match:
                            ...
                            spam_count = 35 # You can adjust this value
                ...
                if "1200" in data.hex()[0:4] and b"/s6" in data:
                    try:
                        ...
                        try:
                            # Attempt to notify the user about the error before restarting
                            json_result = get_available_room(data.hex()[100:])
                            parsed_data = json.loads(json_result)
                            uid = parsed_data["5"]["data"]["1"]["data"]
                            clients.send(self.GenResponsMsg("[C][B][FF0000]An error occurred. Restarting bot...", uid))
                        except:
...
[FFD700]✨ Developer —͟͞͞ </>  DULU  ⚡""",
                ...
                if "1200" in data.hex()[0:4] and b"WELCOME TO [FFFFF00]DULU [ffffff]BOT" in data:
                    pass
                else:
